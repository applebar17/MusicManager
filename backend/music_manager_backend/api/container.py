...
class SqliteRepositoryBundle:
    ...
    library_metadata_repository: SqliteLibraryMetadataRepository
    ...
    song_library_link_repository: SqliteSongLibraryLinkRepository
    ...
    def open(cls, database_path: Path) -> "SqliteRepositoryBundle":
        ...
        return cls(
            ...
            library_metadata_repository=SqliteLibraryMetadataRepository(connection),
            ...
            song_library_link_repository=SqliteSongLibraryLinkRepository(connection),
